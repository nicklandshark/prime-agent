...
// descriptor are loaded only through the dedicated `./cursor-agent` subpath.
export type { CursorAgentOptions } from "./providers/cursor-agent/index.js";
...
export * from "./utils/cursor-agent-blocks.js";
