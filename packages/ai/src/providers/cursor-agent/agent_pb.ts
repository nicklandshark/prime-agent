// Generated from the Cursor schema baseline in agent.proto, preserved from OMP commit
...
// This provenance statement does not assert that Cursor publishes the schema under MIT.
