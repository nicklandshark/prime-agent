...
export const MODELS = {
	...
	"cursor": {
		"auto": {
			...
			contextWindow: 200000,
			maxTokens: 8192,
		} satisfies Model<"cursor-cloud-agents">,
		"cloud-agent": {
			id: "cloud-agent",
	...
	"cursor-agent": {
		"cursor-grok-4.5-high": {
			...
			reasoning: true,
			thinkingLevelMap: {"off":null,"minimal":null,"low":null,"medium":"cursor-grok-4.5-low","high":"cursor-grok-4.5-medium","xhigh":"cursor-grok-4.5-high","max":null},
			input: ["text"],
		...
		"kimi-k3-max": {
			...
			baseUrl: "https://api2.cursor.sh",
			reasoning: true,
			thinkingLevelMap: {"off":null,"minimal":null,"low":"kimi-k3-low","medium":null,"high":"kimi-k3-high","xhigh":null,"max":"kimi-k3-max"},
			input: ["text"],
			// Published model-pool rates (USD/M tokens), not Cursor plan or invoice pricing.
			cost: {
				input: 3,
